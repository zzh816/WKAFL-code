...
with open('./results/CELEBA_WKAFL_NoNonIIDness_testloss.txt', 'a+') as fl:
...
with open('./results/CELEBA_WKAFL_NoNonIIDness_testacc.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, CB1 is {}, '.
             format(args.users_total, args.K, args.batch_size, args.lr, args.CB1))
    fl.write('CB2 is {}, threshold is {}, total itr is {}, itr_test is {})\n'.
        format(args.CB2, args.threshold, args.itr_numbers, args.log_test))
    fl.write('WKAFL(No Non-IIDness): ' + str(logs['test_acc']) + '\t')

with open('./results/CELEBA_WKAFL_NoNonIIDness_trainloss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, CB1 is {}, '.
             format(args.users_total, args.K, args.batch_size, args.lr, args.CB1))
    fl.write('CB2 is {}, threshold is {}, total itr is {}, itr_test is {})\n'.
             format(args.CB2, args.threshold, args.itr_numbers, args.log_test))
